    ...
    app.post('/signup', function (req, res, next) {
        if(req.session.type && req.session.type!=""){
            ...
            if (!req.body.username){
                ...
                res.render('signup.mail', {msgError:"Veuillez saisir un mail !", msgSuccess: "", session : req.session});
                ...
                rp({
                    ...
                    if(body.code == "0"){
                        res.render('signup.ejs', {msgError:"Cet Utilisateur existe déjà !", msgSuccess: "", session : req.session});
                    }else{
                        rp({
                            url: urlApi+"/user" ,
                            method: "POST",
